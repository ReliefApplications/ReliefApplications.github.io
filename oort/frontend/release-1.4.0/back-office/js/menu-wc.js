                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/CalculatedFieldsTabRoutingModule.html" data-type="entity-link" >CalculatedFieldsTabRoutingModule</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CalculatedFieldUpdateMutationResponse.html" data-type="entity-link" >CalculatedFieldUpdateMutationResponse</a>
                            </li>
                            <li class="link">
